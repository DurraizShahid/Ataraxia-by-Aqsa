  ...
  return (
    <div className="container mx-auto py-16 px-4">
      ...
      <div className="prose max-w-none text-muted-foreground">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">1. Accessing the Website and Account Security</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">3. Prohibited Uses</h2>
